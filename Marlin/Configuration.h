...
#define STRING_CONFIG_H_AUTHOR "(Oleksii Shavykin, FlyingbearGhost5)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 11.34
  #define DEFAULT_bedKi 2.08
  #define DEFAULT_bedKd 41.13
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.00, 80, 400, 408 }
